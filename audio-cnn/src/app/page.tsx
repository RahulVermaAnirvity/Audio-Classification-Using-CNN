          ...
          <Card className="mb-8 border-stone-200 bg-stone-50">
            ...
            <CardContent>
              <p className="mb-4 text-stone-600">
                Download sample audio files from the ESC-50 dataset to test the application:
              </p>
              <Link
              ...
              >
                <Button variant="outline" className="border-stone-300">
                  📥 Download Sample Audio from ESC-50
                </Button>
              </Link>
              <p className="mt-3 text-sm text-stone-500">
                ESC-50 is a labeled collection of 2000 environmental audio recordings suitable for benchmarking.
              </p>
            </CardContent>
          </Card>
        )}
